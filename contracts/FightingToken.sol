...
contract FightingToken is ERC20, Ownable, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 1000000 * 10**18;
    uint256 public constant INITIAL_SUPPLY = 100000 * 10**18;
    
    uint256 public combatRewardAmount = 10 * 10**18;
    ...
    constructor() ERC20("Avalanche Combat Token", "FIGHT") Ownable(msg.sender) {
    ...
    function mintCombatReward(address player, uint256 score, bool isTournament) 
        external 
        nonReentrant 
    {
        require(authorizedMinters[msg.sender], "Not authorized to mint");
        
        uint256 baseReward = combatRewardAmount;
        ...
        string memory reason = isTournament ? "Tournament Combat" : "Practice Combat";
    ...
    function setCombatRewardAmount(uint256 newAmount) external onlyOwner {
        combatRewardAmount = newAmount;
    }
