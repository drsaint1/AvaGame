      ...
      return (
        ...
        >
          <div style={{ maxWidth: "600px", width: "100%" }}>
            ...
            >
              Something went wrong with the space fleet game. Don't worry - your ship
            ...
            >
              ...
              >
                <li>NFT ships are stored on Avalanche blockchain</li>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-purple-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-900 rounded-lg p-6 text-center">
        ...
        <p className="text-xs text-gray-500 mt-4">
          Your NFT ships and progress are safely stored on Avalanche
        </p>
      </div>
    </div>
  );
