export const FIGHTING_CONTRACT_ABI = [
  {
    inputs: [],
...
export const CONTRACT_ADDRESSES = {
  FIGHTING: import.meta.env.VITE_FIGHTING_CONTRACT_ADDRESS as `0x${string}`,
  TOURNAMENTS: import.meta.env
    .VITE_TOURNAMENTS_CONTRACT_ADDRESS as `0x${string}`,
  TOKEN: import.meta.env.VITE_FIGHTING_TOKEN_ADDRESS as `0x${string}`,
} as const;
